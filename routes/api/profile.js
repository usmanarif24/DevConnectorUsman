...
//  @desc     adds experience array object onto the profile
//  @access   Private
...
//  @desc     Deletes experience array object from the profile
//  @access   Private
...
//  @desc     adds education array object onto the profile
//  @access   Private
...
//  @desc     Deletes education array object from the profile
//  @access   Private
  ...
  try {
    ...
    request(options, (error, response, body) => {
      ...
      if (response.statusCode !== 200) {
        res.status(404).json({ msg: "No Github repository found" });
      }
